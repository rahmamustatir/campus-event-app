...
<body class="bg-gray-50 min-h-screen">
    ...
    <nav class="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between">
        ...
        <div class="flex gap-8 text-sm font-semibold text-gray-700">
            ...
            <a href="#" class="hover:text-blue-600 transition">Kelola Event</a>
    ...
    <main class="p-8 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <p class="text-4xl font-bold mt-2 text-blue-800">{{ $totalMahasiswa ?? 0 }}</p>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <p class="text-xs font-bold text-gray-500 uppercase">Pendaftaran Masuk</p>
                <p class="text-4xl font-bold mt-2 text-blue-800">{{ $totalPendaftaran ?? 0 }}</p>
            </div>
        </div>
    </main>
